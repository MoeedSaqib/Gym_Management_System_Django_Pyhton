...
class SubPlanAdmin(admin.ModelAdmin):
	list_editable=('price','highlight_status','max_member','validity_days')
	list_display=('title','price','highlight_status','validity_days','max_member')
...
class SubPlanFeatureAdmin(admin.ModelAdmin):
	...
	def subplan(self,obj):
		return " | ".join([sub.title for sub in obj.subplans.all()])
