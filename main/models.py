...
class SubPlanFeature(models.Model):
	#subplans=models.ForeignKey(SubPlan, on_delete=models.CASCADE,null=True)
	subplans=models.ManyToManyField(SubPlan)
	title=models.CharField(max_length=150)
...
class AppSetting(models.Model):
	logo_img=models.ImageField(upload_to='app_logos/', blank=True, null=True)
	def image_tag(self):
